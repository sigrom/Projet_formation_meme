function CRUD(restAdr) {
     ...
     * @param {*} unsuccesscallback 
     */
    this.post = function (resourceUrl, successcallback, body,contentType, unsuccesscallback) {
        this.callXHR(resourceUrl, successcallback, 'POST', undefined,body,contentType, unsuccesscallback);
    }/**
     * 
     * @param {*} resourceUrl 
     * @param {*} successcallback 
